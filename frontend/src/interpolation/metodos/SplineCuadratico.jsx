...
const SplineCuadratico = ({ name }) => {
  ...
  const handleSubmit = async event => {
    ...
    try{
        ...
        const res = await fetch("http://127.0.0.1:8000/api/interpolation/calcular_spline_cuadrado/", 
        {
            method: "POST", 
            mode: "cors", 
            cache: "no-cache",
  ...
  return (
    ...
    <Button>Spline Cuadratico</Button>
    </form>
    </Parameters>
