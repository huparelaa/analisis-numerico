...
const Vandermonde = ({ name }) => {
  ...
  const handleSubmit = async event => {
    ...
    try{
        ...
        const res = await fetch("http://127.0.0.1:8000/api/interpolation/calcular_vandermonde/", 
        {
            method: "POST", 
            mode: "cors", 
            cache: "no-cache",
            ...
            data => {
                ...
                setMatriz(data["Matriz_de_Vandermonde"])
  ...
  return (
    ...
    <p>
        <li>
        <strong>Polinomio de Vandermonde: </strong>
        {pol}
        </li>
        
    </p>
    <React.Fragment>
              <strong> <p>Matriz de Vandermonde</p> </strong>
              <BlockMath
                math={
                  renderLatexMatrix(matriz) 
                }
              />
                      <LinkGraph>
                <a
