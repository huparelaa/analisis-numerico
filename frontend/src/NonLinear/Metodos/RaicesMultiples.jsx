...
const RaicesMultiples = ({ name }) => {
    ...
    const handleSubmit = async event => {
        ...
        try {
            ...
            const res = await fetch("http://127.0.0.1:8000/api/linear_eq/calcular_raices_multiples/", 
                {
                    method: "POST", 
            ...
            <MediaContainer width={"900px"}>
                <Parameters width={"900px"}>
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <label>
                            Tolerancia
                            <input type="text" name="tol" defaultValue={tol} style={{
                                border: '1px solid #000',
                                borderRadius: '20px',
                                width: '250px',
                                height: '35px',
                        ...
                        <label>
                            ...
                            <input type="text" name="maxCount" defaultValue={iter} style={{
                                border: '1px solid #000',
                                borderRadius: '20px',
                                width: '250px',
                                height: '35px',
                    ...
                    {data &&  Array.from({ length: Object.entries(data)[0][1] }).map((_, index) => (
                        <tr key={index}>
                            ...
                            { !Array.isArray(Object.entries(data)[1][1]) &&
                                <td key={1}>{format( Object.entries(data)[1][1], { notation: "fixed", precision: 15 })}</td>
                            }  
